...
def notice():
	...
	runtxt("\n        Admin :- NOMI KING")
	print("")
	runtxt("\033[1;32m        YouTube Channel :- DEVIL TRICK'S")
	print("")
	runtxt("\033[1;33m        Team :- NOMI + SANA + FIZA")
	print("")
	runtxt("\033[1;33m            🌹🌹🌹🌹🌹🌹🌹🌹🌹🌹")
	print("")
...
if Ahmad in [""]:
	...
	os.system('xdg-open https://chat.whatsapp.com/CDf0ou3NKcB30FRTOjzi7T')
	time.sleep(1.0)
	os.system('clear')
	print(logo)
print("[🔥]•••••••••••••••••{N + S + F}•••••••••••••••••[🔥]")
